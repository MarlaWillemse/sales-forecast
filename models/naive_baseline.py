...
train_x = pd.read_pickle(root+"/data/interim/train_x.pkl")
train_y = pd.read_pickle(root+"/data/interim/train_y.pkl").fillna(value=0)
test_x = pd.read_pickle(root+"/data/interim/test_x.pkl")
test_y = pd.read_pickle(root+"/data/interim/test_y.pkl").fillna(value=0)
